						...
						<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12" style="margin-top:2%;" >
							...
							<ul class="nav navbar-nav" >
								...
								<li><a href="#" class="active"><span class="pull-left"><i class="fa fa-sitemap"></i></span>&nbsp;&nbsp;Organisation</a>
									<ul class="dropdown">
										<li><a href="committee.html?ref_id=1" <?php if($ref_id == 1) { ?> class="active" <?php } ?>>Organising Committee<span class="pull-right"><i class="fa fa-group"></i></span></a>
										</li>

										<li><a href="committee.html?ref_id=2" <?php if($ref_id == 2) { ?> class="active" <?php } ?>>Advisory Committee<span class="pull-right"><i class="fa fa-group"></i></span></a>
										</li>
				...
				<ul class="wpb-mobile-menu">
					...
					<li><a href="#" class="active"><span class="pull-left"><i class="fa fa-sitemap"></i></span>&nbsp;&nbsp;Organisation</a>
						<ul class="dropdown">
							...
							<li><a href="committee.html?ref_id=2" <?php if($ref_id == 2) { ?> class="active" <?php } ?>>Advisory Committee Committee<span class="pull-right"><i class="fa fa-group"></i></span></a>
							</li>
				...
				{ 
					...
					<table class="table table-responsive table-condensed table-bordered">
						...
						<tr>
							...
							<td>Prof. P.H. Sawant<br>Prof. A.K. Sharma</td>
						...
						<tr>
							<td>Convener</td>
							<td>Dr. Mrs. M.A. Shah<br>Dr. A. J. Umbarkar</td>
							<td>HoD, Department of Computer Science and Engineering, WCE<br>HoD, Department of Information Technology, WCE</td>
						</tr>

						<tr>
							<td>IET Pune Local Network Office Bearers</td>
							<td>Dr. Madhuri Joshi<br> 
								 
								Dr. Anil S. Hiwale<br> 
								Dr. Anuradha D. Thakare<br>
								 
								Mr. Deepak Kshirsagar<br>
								Dr. Dayaram Sonawane<br> 
							</td>
							<td>
								Past Chairman<br> 
								Chairman<br> 
					...
					<div class="row">
						<div class="col-sm-12">
							<table class="table table-responsive table-condensed table-bordered">
								...
								<tr>
									<td>
										Dr. R Venkateswaran (Persistent), Pune
									</td>
								</tr>
								<tr>
									<td>
								...
								<tr>
									<td>
										Dr. Shashidhar Koolagudi (NIT), Surathkal
									</td>
								</tr>
								<tr>
									<td>
										Dr. Umakant Kulkarni (SDM), Dharwad
									</td>
								</tr>
								<tr>
									<td>
										Dr. Vidyadhar Dharmadhikari (WCE), Sangli
									</td>
								</tr>
								<tr>
									<td>
